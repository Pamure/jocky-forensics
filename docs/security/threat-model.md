...
*roadmap*. Measurements are from this host against v1.2.0. [Honest limits](limits.md)
...
* The detector matched a *pattern table* (`CMD_PATTERNS`) against
  ...
  repository, and published on [Detection checks](../runtime/detection.md) — can evade it by
  changing their argv.
...
verbatim, so the same discipline is needed at both exits: [Roadmap](../project/roadmap.md)
...
three are on [Roadmap](../project/roadmap.md) (tiers 1–2).
...
kernel-mode boundary itself is out of scope on [Roadmap](../project/roadmap.md).
...
[Roadmap](../project/roadmap.md); [Evidence harness](../operations/evidence.md) covers what the harness does
and does not prove.
...
scheduled on [Roadmap](../project/roadmap.md)**: shipped hardening covers pinning, token
...
argument on [Honest limits](limits.md)). Evidence bundles: `jocky attest` writes a
...
[Honest limits](limits.md) · [Detection checks](../runtime/detection.md) · [Fileless execution](../execution/fileless.md) · [Server & agents](../operations/management.md) · [Evidence harness](../operations/evidence.md) · [Roadmap](../project/roadmap.md).
